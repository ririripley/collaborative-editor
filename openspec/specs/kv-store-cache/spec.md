...
Defines the in-memory caching layer of the KVStore, including how values are stored in memory, the configurable limits that govern cache capacity, the eviction policies available, and how the cache responds to system memory pressure.
