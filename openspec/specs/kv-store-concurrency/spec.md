...
Defines the concurrency model for the KVStore, covering how the in-memory cache and persistent store are each protected against concurrent access, and how lock compatibility is maintained across supported iOS versions.
