...
Defines the public API of the KVStore: the operations callers use to store, retrieve, delete, and enumerate key-value pairs, along with the read/write path that coordinates the in-memory cache and persistent storage.
