...
Defines how the KVStore durably stores key-value pairs, covering inline SQLite storage for small values, File System blob storage for large values, atomic write guarantees, WAL mode, startup integrity checking, and disk-space eviction.
